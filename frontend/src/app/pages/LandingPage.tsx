...
export const LandingPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-[#F8FAFC]">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          <div data-aos="fade-right">
            ...
            <p className="text-lg sm:text-xl text-gray-600 mb-6 leading-relaxed text-center lg:text-left">
              Go beyond simple syntax checks. Our 7-layer verification engine
              performs SMTP handshakes and DNS security audits to ensure 99.9%
              deliverability.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Link to="/signup" className="w-full sm:w-auto">
                <button className="w-full bg-[#2563EB] text-white text-base sm:text-lg px-6 py-4 sm:px-8 sm:py-5 shadow-lg hover:shadow-2xl hover:-translate-y-1 active:scale-95 transition-all rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-[#1E40AF]">
                  Start Free Trial
                  <ArrowRight className="w-5 h-5" />
                </button>
              </Link>
              <Link to="/docs" className="w-full sm:w-auto">
                <button className="w-full bg-white border-2 border-[#2563EB] text-[#2563EB] text-base sm:text-lg px-6 py-4 sm:px-8 sm:py-5 active:scale-95 transition-all rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-blue-50 hover:shadow-xl hover:-translate-y-1">
                  View Documentation
                </button>
              </Link>
            </div>
      ...
      {/* Features Grid */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 bg-white rounded-[3rem] my-12 border border-blue-50">
        <div className="text-center mb-16" data-aos="fade-up">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">
            The World's Most Comprehensive Verification Engine
          </h2>
          <p className="text-xl text-gray-600">
            Our 6-layer technology stacks deep technical checks to guarantee
          ...
          {[
            {
              ...
              description:
                "Real-time connection to recipient servers to verify inbox state.",
              color: "blue",
            },
            {
              icon: Shield,
              title: "DNS Security",
              description:
                "Deep analysis of SPF, DKIM, and DMARC for sender trust.",
              color: "green",
            },
            {
              icon: Globe,
              ...
              description:
                "Filters out burner domains and evaluates domain authority.",
              color: "blue",
            },
            {
              icon: Search,
              ...
              description:
                "Detects bot-generated and suspicious email structures.",
              color: "green",
            },
            {
              icon: FileCheck,
              ...
              description:
                "Instantly flags temporary and disposable provider emails.",
              color: "blue",
            },
            {
              icon: Users,
              ...
              description:
                "Identifies catch-all and role-based (support/admin) emails.",
              color: "green",
            },
            {
              icon: TrendingUp,
              title: "Typo Suggest",
              description:
                "Suggests corrections for common domain misspellings.",
              color: "amber",
            },
            {
              icon: Activity,
              title: "99.9% Accuracy",
              description:
                "High-precision verification for reliable deliverability.",
              color: "amber",
            },
          ].map((feature, index) => {
            ...
            return (
              <Card
                key={index}
                className="border-[#E5E7EB] border-opacity-50 hover:shadow-[0_20px_50px_rgba(37,99,235,0.1)] transition-all duration-300 hover:-translate-y-2 group cursor-default"
                data-aos="fade-up"
                data-aos-delay={index * 50}
              >
                <CardContent className="p-8">
                  <div
                    className={`w-14 h-14 rounded-2xl ${colorClasses[feature.color as keyof typeof colorClasses]} flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-sm group-hover:shadow-md`}
                  >
                  ...
                  <p className="text-gray-600 leading-relaxed text-sm group-hover:text-gray-900 transition-colors">
                    {feature.description}
                  </p>
                </CardContent>
              </Card>
              ...
              {[
                ...
                >
                  <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-slate-800 border border-slate-700 flex items-center justify-center text-blue-400 mb-4 group-hover:bg-blue-600 group-hover:text-white group-hover:border-blue-500 group-hover:scale-110 group-hover:-rotate-6 transition-all duration-500 relative z-20 shadow-xl group-hover:shadow-[0_0_30px_rgba(37,99,235,0.3)]">
                    ...
                    <span className="absolute -top-1 -right-1 bg-blue-600 text-white text-[10px] sm:text-xs font-bold px-2 py-0.5 rounded-full border border-slate-900 group-hover:scale-110 transition-transform">
                      {item.step}
                    </span>
                  </div>
                  <h4 className="text-white font-bold mb-1 text-sm sm:text-base group-hover:text-blue-400 transition-colors">
                    {item.title}
                  </h4>
                  <p className="text-slate-500 text-[10px] sm:text-xs group-hover:text-slate-300 transition-colors">
                    {item.desc}
                  </p>
                </div>
              ))}
            ...
            <div className="inline-block p-[1px] rounded-full bg-gradient-to-r from-blue-500 to-indigo-500">
              <div className="bg-slate-900 px-8 py-4 rounded-full">
                <p className="text-slate-300 text-sm">
                  <span className="text-blue-400 font-bold">Pro Tip:</span> Our
                  system completes all 6 steps in less than{" "}
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            },
            {
              ...
              text: "Professional-grade accuracy and excellent bulk processing. Highly recommended.",
              rating: 5,
            },
          ].map((testimonial, index) => (
            <Card
              key={index}
              className="border-[#E5E7EB] hover:shadow-lg transition-all hover:-translate-y-2"
              data-aos="fade-up"
              data-aos-delay={index * 100}
            >
              <CardContent className="p-8">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-0">
        <Card
          className="bg-gradient-to-r from-[#2563EB] to-[#1E3A8A] border-none shadow-2xl"
          data-aos="flip-up"
        >
          <CardContent className="p-12 lg:p-16 text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Join thousands of businesses that trust VerifyMail for their email
              verification needs.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/signup">
                <button className="bg-white text-[#2563EB] text-base sm:text-lg px-6 py-4 sm:px-8 sm:py-5 shadow-xl w-full sm:w-auto rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-blue-50 hover:shadow-2xl hover:-translate-y-1 active:scale-95 transition-all">
                  Start Free Trial
                  <ArrowRight className="w-5 h-5" />
                </button>
              </Link>
