      ...
      <div className="max-w-7xl mx-auto bg-white/90 backdrop-blur-md border border-[#E5E7EB] sm:border-white/20 shadow-lg rounded-xl sm:rounded-2xl px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link to="/" className="flex items-center gap-2">
            ...
            />
            <span className="text-xl font-bold text-[#1E3A8A] truncate">
              QuickMailFilter
            </span>
          </Link>
          ...
          >
            {!isAuthenticated ? (
              <>
                <Link
                  to="/"
                  className="text-gray-600 hover:text-[#2563EB] transition-colors relative group text-sm font-medium"
                >
                  Home
                ...
                <Link to="/login">
                  <Button
                    variant="ghost"
                    className="hover:text-[#2563EB] hover:bg-blue-50 transition-all text-sm font-medium"
                  >
                    Login
                  </Button>
                </Link>
                <Link to="/signup">
                  <Button className="bg-[#2563EB] hover:bg-[#1E40AF] shadow-md hover:shadow-xl hover:-translate-y-0.5 active:scale-95 transition-all text-sm font-medium">
                    Start Free Trial
                  </Button>
                </Link>
              </>
            ...
            {!isAuthenticated ? (
              ...
              <div className="flex flex-col gap-1 px-2">
                ...
                <Button
                  ...
                  variant="outline"
                  className="mx-2 mt-2 border-red-200 text-red-600 hover:bg-red-50"
                >
                  Logout
                </Button>
              </div>
